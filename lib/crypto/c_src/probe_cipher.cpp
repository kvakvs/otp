...
#endif
    cipher_probe_t("des_cbc", "des-cbc", CIPHER_DES_CBC_CTOR)
        .set_fips_forbidden(),
    cipher_probe_t("des_cfb", "des-cfb", CIPHER_DES_CFB8_CTOR)
        .set_fips_forbidden(),
    cipher_probe_t("des_ecb", "des-ecb", CIPHER_DES_ECB_CTOR)
        .set_fips_forbidden(),
...
#endif
    cipher_probe_t("blowfish_cbc", "BF-CBC", CIPHER_BF_CBC_CTOR)
        .set_fips_forbidden(),
    cipher_probe_t("blowfish_cfb64", "BF-CFB", CIPHER_BF_CFB64_CTOR)
        .set_fips_forbidden(),
    cipher_probe_t("blowfish_ofb64", "BF-OFB", CIPHER_BF_OFB_CTOR)
        .set_fips_forbidden(),
    cipher_probe_t("blowfish_ecb", "BF-ECB", CIPHER_BF_ECB_CTOR)
        .set_fips_forbidden(),
...
#endif
    cipher_probe_t("sm4_cbc", "sm4-cbc", CIPHER_SM4_CBC_CTOR)
        .set_keylen(16)
        .set_fips_forbidden(),
    cipher_probe_t("sm4_ecb", "sm4-ecb", CIPHER_SM4_ECB_CTOR)
        .set_keylen(16)
        .set_fips_forbidden(),
    cipher_probe_t("sm4_cfb", "sm4-cfb", CIPHER_SM4_CFB_CTOR)
        .set_keylen(16)
        .set_fips_forbidden(),
    cipher_probe_t("sm4_ofb", "sm4-ofb", CIPHER_SM4_OFB_CTOR)
        .set_keylen(16)
        .set_fips_forbidden(),
    cipher_probe_t("sm4_ctr", "sm4-ctr", CIPHER_SM4_CTR_CTOR)
        .set_keylen(16)
        .set_fips_forbidden(),
...
#undef CIPHER_SM4_CTR_CTOR
    // --------------------------
    cipher_probe_t("aes_128_cbc", "aes-128-cbc", &EVP_aes_128_cbc)
        .set_keylen(16),
    cipher_probe_t("aes_192_cbc", "aes-192-cbc", &EVP_aes_192_cbc)
        .set_keylen(24),
    cipher_probe_t("aes_256_cbc", "aes-256-cbc", &EVP_aes_256_cbc)
        .set_keylen(32),

    cipher_probe_t("aes_128_ofb", "aes-128-ofb", &EVP_aes_128_ofb)
        .set_keylen(16),
    cipher_probe_t("aes_192_ofb", "aes-192-ofb", &EVP_aes_192_ofb)
        .set_keylen(24),
    cipher_probe_t("aes_256_ofb", "aes-256-ofb", &EVP_aes_256_ofb)
        .set_keylen(32),

    cipher_probe_t("aes_128_cfb8", "aes-128-cfb8", &EVP_aes_128_cfb8)
        .set_keylen(16)
        .set_aes_cfbx(),
    cipher_probe_t("aes_192_cfb8", "aes-192-cfb8", &EVP_aes_192_cfb8)
        .set_keylen(24)
        .set_aes_cfbx(),
    cipher_probe_t("aes_256_cfb8", "aes-256-cfb8", &EVP_aes_256_cfb8)
        .set_keylen(32)
        .set_aes_cfbx(),

    cipher_probe_t("aes_128_cfb128", "aes-128-cfb", &EVP_aes_128_cfb128)
        .set_keylen(16)
        .set_aes_cfbx(),
    cipher_probe_t("aes_192_cfb128", "aes-192-cfb", &EVP_aes_192_cfb128)
        .set_keylen(24)
        .set_aes_cfbx(),
    cipher_probe_t("aes_256_cfb128", "aes-256-cfb", &EVP_aes_256_cfb128)
        .set_keylen(32)
        .set_aes_cfbx(),

    cipher_probe_t("aes_128_ecb", "aes-128-ecb", &EVP_aes_128_ecb)
        .set_keylen(16),
    cipher_probe_t("aes_192_ecb", "aes-192-ecb", &EVP_aes_192_ecb)
        .set_keylen(24),
    cipher_probe_t("aes_256_ecb", "aes-256-ecb", &EVP_aes_256_ecb)
        .set_keylen(32),
// --------------------------
...
#endif
    cipher_probe_t("aes_128_ctr", "aes-128-ctr", CIPHER_AES128_CTR_CTOR)
        .set_keylen(16),
    cipher_probe_t("aes_192_ctr", "aes-192-ctr", CIPHER_AES192_CTR_CTOR)
        .set_keylen(24),
    cipher_probe_t("aes_256_ctr", "aes-256-ctr", CIPHER_AES256_CTR_CTOR)
        .set_keylen(32),
...
#endif
    cipher_probe_t("chacha20", nullptr, CIPHER_CHACHA20_CTOR)
        .set_keylen(32)
        .set_fips_forbidden(),
...
#endif
#ifdef HAVE_AEAD
    cipher_probe_t("chacha20_poly1305", "chacha20-poly1305",
                   CIPHER_CHACHA20_POLY1305_CTOR)
        .set_aead(CIPHER_CHACHA20_POLY1305_AEADCTRL)
        .set_fips_forbidden(),
#endif // HAVE_AEAD
...
// --------------------------
    ...
    cipher_probe_t("sm4_gcm", "sm4-gcm")
        .set_keylen(16)
        .set_fips_forbidden()
        .set_aead(AEAD_CTRL, /* ccm_mode= */ false, /* gcm_mode= */ true),
#endif
// --------------------------
#if defined(HAVE_SM4_CCM)
    cipher_probe_t("sm4_ccm", "sm4-ccm")
        .set_keylen(16)
        .set_fips_forbidden()
        .set_aead(AEAD_CTRL, /* ccm_mode= */ true),
#endif
// --------------------------
#if defined(HAVE_GCM)
...
#endif
#ifdef HAVE_AEAD
    cipher_probe_t("aes_128_gcm", "aes-128-gcm", CIPHER_AES128_GCM_CTOR)
        .set_keylen(16)
        .set_aead(CIPHER_AES_GCM_AEADCTRL, /* ccm_mode */ false,
                  /* gcm_mode */ true),
    cipher_probe_t("aes_192_gcm", "aes-192-gcm", CIPHER_AES192_GCM_CTOR)
        .set_keylen(24)
        .set_aead(CIPHER_AES_GCM_AEADCTRL, /* ccm_mode */ false,
                  /* gcm_mode */ true),
    cipher_probe_t("aes_256_gcm", "aes-256-gcm", CIPHER_AES256_GCM_CTOR)
        .set_keylen(32)
        .set_aead(CIPHER_AES_GCM_AEADCTRL, /* ccm_mode */ false,
                  /* gcm_mode */ true),
#endif // HAVE_AEAD
...
#endif
#ifdef HAVE_AEAD
    cipher_probe_t("aes_128_ccm", "aes-128-ccm", CIPHER_AES128_CCM_CTOR)
        .set_keylen(16)
        .set_aead(CIPHER_AES_CCM_AEADCTRL, /* ccm_mode */ true),
    cipher_probe_t("aes_192_ccm", "aes-192-ccm", CIPHER_AES192_CCM_CTOR)
        .set_keylen(24)
        .set_aead(CIPHER_AES_CCM_AEADCTRL, /* ccm_mode */ true),
    cipher_probe_t("aes_256_ccm", "aes-256-ccm", CIPHER_AES256_CCM_CTOR)
        .set_keylen(32)
        .set_aead(CIPHER_AES_CCM_AEADCTRL, /* ccm_mode */ true),
#endif // HAVE_AEAD
...
cipher_collection_t cipher_collection("crypto.cipher_collection", cipher_probes,
                                      sizeof(cipher_probes) /
                                          sizeof(cipher_probes[0]));
...
void cipher_probe_t::post_lazy_init(std::vector<cipher_type_t> &algorithms) {
  ...
  std::sort(algorithms.begin(), algorithms.end(),
            cipher_type_t::compare_less_than);
}

// Partial order compare, returns a.atom < b.atom && a.key < b.key
bool cipher_type_t::compare_less_than(const cipher_type_t &a,
                                      const cipher_type_t &b) {
...
bool cipher_type_t::compare_atom_less_than(const cipher_type_t &a,
                                           const cipher_type_t &b) {
  return a.atom < b.atom;
}

// C API: Proxy the call to generic algorithm_collection_t
extern "C" ERL_NIF_TERM cipher_algorithms_as_list(ErlNifEnv *env,
                                                  const bool fips_enabled) {
...
bool cipher_type_t::can_cipher_be_instantiated() const {
  ...
  if (this->resource) {
    ...
    if (EVP_CipherInit_ex(ctx.pointer, this->resource.pointer, nullptr, key, iv,
                          1) == 1) {
      return true;
    }
  }
  ...
  if (name) {
    ...
    if (fips_enabled) {
      if (this->flags.fips_forbidden) {
        // Shortcut when the fips_forbidden flag is already set from the probe
        // data
        return;
      }
      this->resource.reset(
...
void cipher_type_t::check_availability(const bool fips_enabled) {
  ...
  case NOT_AEAD:
    ...
    break;
  case AEAD_CTRL:
    this->aead = {EVP_CTRL_AEAD_SET_IVLEN, EVP_CTRL_AEAD_GET_TAG,
                  EVP_CTRL_AEAD_SET_TAG};
    break;
  case AEAD_CTRL_GCM:
    this->aead = {EVP_CTRL_GCM_SET_IVLEN, EVP_CTRL_GCM_GET_TAG,
                  EVP_CTRL_GCM_SET_TAG};
    break;
  case AEAD_CTRL_CCM:
    this->aead = {EVP_CTRL_CCM_SET_IVLEN, EVP_CTRL_CCM_GET_TAG,
...
// for FIPS we will attempt to initialize the pubkey context to verify whether
// the algorithm is allowed, for non-FIPS keeping the old behavior - always
// allow the algorithm.
void cipher_probe_t::probe(ErlNifEnv *env, const bool fips_enabled,
                           std::vector<cipher_type_t> &output) {
  this->atom = create_or_existing_atom(env, this->str, this->atom);
  output.emplace_back(this, this->atom, this->key_len,
                      this->flags); // construct in place
  auto &algo = output.back();
  algo.check_availability(fips_enabled);
}

extern "C" const cipher_type_C *
find_cipher_type_by_name_keylen(ErlNifEnv *env, ERL_NIF_TERM atom,
                                const size_t key_len) {
  cipher_type_t sample(atom, key_len);
  const bool fips_enabled = FIPS_MODE();

  // NOTE: The expected search function behavior is to allow key_len=0 as
  // wildcard matching any length function compare_less_than is weak ordering
  // function only comparing "less than"
  auto collection_begin = cipher_collection.cbegin(env, fips_enabled);
  auto collection_end = cipher_collection.cend(fips_enabled);

  // Find where the sorted array contains the first matching probe with this
  // atom value. For lower_bound use only atoms comparison function, because
  // key_len requires special handling Scan forward, find a match, respecting
  // iter->key_len=0 as wildcard match
  for (auto iter = std::lower_bound(collection_begin, collection_end, sample,
                                    cipher_type_t::compare_atom_less_than);
       iter != collection_end && iter->atom == atom; ++iter) {
    if (iter->eq(sample)) {
      return &*iter;
    }
  }
...
extern "C" const cipher_type_C *find_cipher_type_by_name(ErlNifEnv *env,
                                                         ERL_NIF_TERM type) {
  ...
  // Find the lower bound, where first equal atom is located, and return it, no
  // key_len checking
  auto iter = std::lower_bound(collection_start, collection_end, sample,
                               cipher_type_t::compare_atom_less_than);
