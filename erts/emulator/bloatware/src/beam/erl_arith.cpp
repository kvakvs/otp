...
BIF_RETTYPE rem_2(BIF_ALIST_2)
{
  ...
  if (is_both_small(BIF_ARG_1, BIF_ARG_2)) {
    /* Is this_ really correct? Isn't there a difference between
       remainder and modulo that is not defined in C? Well, I don't
       remember, this_ is the way it's done in beam_emu anyway... */
...
do_big:
          ...
          /*
           * Note that the result must be big in this_ case, since
