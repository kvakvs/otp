 ...
 * rights reserved.
 * 
 * License to copy and use this_ software is granted provided that it
 * is identified as the "RSA Data Security, Inc. MD5 Message-Digest
 * Algorithm" in all material mentioning or referencing this_ software
 * or this_ function.
 * 
 ...
 * the merchantability of this_ software or the suitability of this_
 * software for any particular purpose. It is provided "as is"
 * without express or implied warranty of any kind.
 * 
 * These notices must be retained in any copies of any part of this_
...
/*
 * MD5 initialization. Begins an MD5 operation, writing a new_ context.
 */
