 ...
 */
#define ERTS_PORT_REDS_EXECUTE    (vm::CONTEXT_REDS/4)
#define ERTS_PORT_REDS_FREE   (vm::CONTEXT_REDS/400)
#define ERTS_PORT_REDS_TIMEOUT    (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_INPUT    (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_OUTPUT   (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_EVENT    (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_CMD_OUTPUTV  (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_CMD_OUTPUT (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_EXIT   (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_CONNECT    (vm::CONTEXT_REDS/200)
#define ERTS_PORT_REDS_UNLINK   (vm::CONTEXT_REDS/200)
#define ERTS_PORT_REDS_LINK   (vm::CONTEXT_REDS/200)
#define ERTS_PORT_REDS_BADSIG   (vm::CONTEXT_REDS/200)
#define ERTS_PORT_REDS_CONTROL    (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_CALL   (vm::CONTEXT_REDS/50)
#define ERTS_PORT_REDS_INFO   (vm::CONTEXT_REDS/100)
#define ERTS_PORT_REDS_TERMINATE  (vm::CONTEXT_REDS/50)
...
erts_proc2port_sig_is_command_op(ErtsProc2PortSigData *sigdp)
{
  ...
  case ERTS_P2P_SIG_TYPE_OUTPUT:
    return !0;

  case ERTS_P2P_SIG_TYPE_OUTPUTV:
    return !0;
...
erts_proc2port_sig_command_data_size(ErtsProc2PortSigData *sigdp)
{
  switch (sigdp->flags & ERTS_P2P_SIG_TYPE_MASK) {
  case ERTS_P2P_SIG_TYPE_OUTPUT:
    return sigdp->u.output.size;

  case ERTS_P2P_SIG_TYPE_OUTPUTV:
    return sigdp->u.outputv.evp->size;

  default:
    return (ErlDrvSizeT) 0;
  }
}
