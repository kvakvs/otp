...
#define MAX_ATOM_SZ_LIMIT (4*MAX_ATOM_CHARACTERS) /* theoretical uint8_t limit */
...
ERTS_GLB_INLINE Atom *atom_tab(size_t i);
...
#define ERTS_IS_ATOM_STR(LSTR, TERM) \
  (erts_is_atom_utf8_bytes((uint8_t *) LSTR, sizeof(LSTR) - 1, (TERM)))
...
void erts_atom_get_text_space_sizes(size_t *reserved, size_t *used);
#endif
