...
{
    ErtsDrvSelectDataState *dsp = (ErtsDrvSelectDataState *) erts_alloc(ERTS_ALC_T_DRV_SEL_D_STATE,
...
{
    ErtsDrvEventDataState *dep = (ErtsDrvEventDataState *) erts_alloc(ERTS_ALC_T_DRV_EV_D_STATE,
...
grow_drv_ev_state(int min_ix)
{
	...
	drv_ev_state = (ErtsDrvEventState *) (drv_ev_state
...
add_active_fd(ErtsSysFdType fd)
{
	...
	pollset.active_fd.array = (ErtsSysFdType *) erts_realloc(ERTS_ALC_T_ACTIVE_FD_ARR,
...
ERTS_CIO_EXPORT(erts_check_io)(int do_wait)
{
 ...
 restart:
    ...
    pollres = (ErtsPollResFd *) erts_alloc(ERTS_ALC_T_TMP, sizeof(ErtsPollResFd)*pollres_len);
...
ERTS_CIO_EXPORT(erts_init_check_io)(void)
{
    ...
    pollset.active_fd.array = (ErtsSysFdType *) erts_alloc(ERTS_ALC_T_ACTIVE_FD_ARR,
...
#ifdef ERTS_SYS_CONTINOUS_FD_NUMBERS
    counters.epep = (ErtsPollEvents *) erts_alloc(ERTS_ALC_T_TMP, sizeof(ErtsPollEvents)*max_fds);
