 ...
 * Unfortunately, this_ has to be specified explicitly for each signal,
 ...
 * Unfortunately, this_ solution doesn't work with earlier versions,
 ...
 * unless this_ is a multithreaded runtime system.
 */
