...
md5_1(BIF_ALIST_1)
{
    ...
    BUMP_REDS(BIF_P,res);
    bin = new_binary(BIF_P, (byte *)nullptr, 16);
...
md5_init_0(BIF_ALIST_0)
{
    ...
    bin = erts_new_heap_binary(BIF_P, (byte *)nullptr, sizeof(MD5_CTX), &bytes);
...
md5_final_1(BIF_ALIST_1)
{
    ...
    bin = erts_new_heap_binary(BIF_P, (byte *)nullptr, 16, &result);
