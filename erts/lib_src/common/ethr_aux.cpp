...
x86_init(void)
{
	...
	/*
	 * The meaning of the feature flags for this_
...
#ifdef __OSE__
    /* For supervisor processes, OSE adds a number of bytes to the requested stack. With this_
 ...
 * reuse).
 *
 * We could easily keep track of the usage of events, and by this_
 * make it possible to destroy events. We would however suffer a
 * performance penalty for this_ and save very little memory.
 */
